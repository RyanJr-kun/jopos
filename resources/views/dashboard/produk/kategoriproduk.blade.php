                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mt-4">
                                    ...
                                    <input id="edit_nama" name="nama" type="text" class="form-control"
                                        required>
                                </div>
                                <div class="mb-3">
...
@section('page-script')
    ...
    <script>
        ...
        function createTableRow(kategori) {
            const statusBadge = kategori.status ? '<span class="badge badge-success">Aktif</span>' :
                            ...
                            .catch(errorData => {
                                if (errorData.errors) {
                                    Object.keys(data.errors).forEach(key => {
                                        ...
                                        if (errorDiv) errorDiv.textContent = errorData.errors[
                                            key][0];
                                    });
                                } else {
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Gagal!',
                                        text: errorData.message || 'Terjadi kesalahan server.'
                                    });
                                }
                            });
                    });
                    ...
                    fetch(url, {
                        ...
                        .then(({
                            ...
                            if (ok && data.success) {
                                ...
                                document.getElementById(`kategori-row-${kategoriSlugToDelete}`)
                                    .remove();
                            } else {
                                Swal.fire({
                                    icon: 'error',
