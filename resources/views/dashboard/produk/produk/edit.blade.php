                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('kategori') is-invalid @enderror" name="kategori" id="kategori"
                        ...
                        @foreach ($kategoris as $kategori)
                            <option value="{{ $kategori->id }}" @selected(old('kategori', $produk->kategori_produk?->id) == $kategori->id)>{{ $kategori->nama }}
                            </option>
                        @endforeach
                    </select>
                    @error('kategori')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('brand') is-invalid @enderror" id="brand" name="brand"
                        ...
                        @foreach ($brands as $brand)
                            <option value="{{ $brand->id }}" @selected(old('brand', $produk->brand?->id) == $brand->id)>{{ $brand->nama }}
                            </option>
                        @endforeach
                    </select>
                    @error('brand')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('unit') is-invalid @enderror" id="unit" name="unit"
                        ...
                        @foreach ($units as $unit)
                            <option value="{{ $unit->id }}" @selected(old('unit', $produk->unit?->id) == $unit->id)>{{ $unit->nama }}
                            </option>
                        @endforeach
                    </select>
                    @error('unit')
    ...
    <div class="card m-4">
        ...
        <div class="card-body px-4 pt-0">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('garansi') is-invalid @enderror" id="garansi" name="garansi"
                        ...
                        @foreach ($garansis as $garansi)
                            <option value="{{ $garansi->id }}" @selected(old('garansi', $produk->garansi_id) == $garansi->id)>{{ $garansi->nama }}
                            </option>
                        @endforeach
                    </select>
                    @error('garansi')
                ...
                <div class="col-md-3">
                    <label for="stok_minimum" class="form-label">Batas Stok Minimum <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('pajak') is-invalid @enderror" id="pajak" name="pajak"
                        ...
                        @foreach ($pajak as $item)
                            <option value="{{ $item->id }}" @selected(old('pajak', $produk->pajak_id) == $item->id)>{{ $item->nama_pajak }}
                            </option>
                        @endforeach
                    </select>
                    @error('pajak')
                ...
                <div class="col-md-12">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label fw-bolder" for="wajib_seri">Produk ini memiliki <u
