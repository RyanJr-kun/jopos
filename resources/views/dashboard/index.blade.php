                                ...
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    ...
                                    @if (auth()->user()->role_id != 2)
                                        <a href="{{ route('pembelian.create') }}"
                                            ...
                                            data-bs-placement="top" title="Beli Produk Ini">
                                ...
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <div class="d-flex align-items-center">
                                        <div
                                            ...
                                            <span
                                                class="text-white font-weight-bold">{{ strtoupper(substr($pelanggan->nama, 0, 2)) }}</span>
                                        </div>
                                        <div>
                                    ...
                                    <li
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text-xs">{{ $sale->pelanggan->nama ?? 'Pelanggan Umum' }}
                                                    &bull;
                                        ...
                                        <li
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="text-xs">{{ $purchase->pemasok->nama ?? 'N/A' }}
                                                        &bull;
