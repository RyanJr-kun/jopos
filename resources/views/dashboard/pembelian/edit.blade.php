                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select me-2 @error('pemasok_id') is-invalid @enderror" name="pemasok_id"
                            ...
                            @foreach ($pemasok as $item)
                                <option value="{{ $item->id }}" @selected(old('pemasok_id', $pembelian->pemasok_id) == $item->id)>{{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
                        @error('pemasok_id')
                            ...
                            <tbody>
                                @foreach ($pembelian->details as $index => $detail)
                                    ...
                                    <tr data-produk-id="{{ $detail->produk_id }}">
                                        ...
                                        <input type="hidden" name="items[{{ $index }}][pajak_id]"
                                            class="item-pajak-id-hidden" value="{{ $detail->pajak_id ?? '' }}">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 text-sm item-nama">{{ $detail->produk->nama_produk }}
                                                </h6>
                                            </div>
                                        </td>
