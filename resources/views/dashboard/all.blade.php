                ...
                <div class="card-header pb-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-sm mb-0">Produk wajib seri yang jumlah stoknya belum sesuai dengan nomor seri
                                terdaftar.</p>
                        </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <div class="d-md-flex text-xs text-secondary">
                                            <div class="me-3">Stok Fisik: <span
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-center px-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <div class="d-md-flex text-xs text-secondary">
                                            <div class="me-3">Stok Minimum: <span
                                                    class="text-dark font-weight-bold">{{ $produk->stok_minimum }}</span>
                                            </div>
                                            <div>Sisa Stok: <strong class="text-danger">{{ $produk->qty }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a href="{{ route('produk.edit', $produk->slug) }}"
                                    ...
                                    <i class="bx bx-pencil-square me-md-2"></i><span class="d-none d-md-inline">Kelola
                                        Stok</span>
                                </a>
                            </div>
                        @empty
