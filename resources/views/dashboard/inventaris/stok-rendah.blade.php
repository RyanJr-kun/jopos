                ...
                <table class="table table-hover align-items-center mb-0">
                    <thead class="table-secondary">
                        <tr>
                            ...
                            <th class="text-uppercase text-dark text-xs font-weight-bolder text-center">Stok Tersedia
                            </th>
                            <th class="text-uppercase text-dark text-xs font-weight-bolder text-center">Stok Minimum
                            </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $produk->kategori_produk->nama ?? 'N/A' }}</p>
                                </td>
                                <td>
                                ...
                                <td class="align-middle">
                                    ...
                                    @if (auth()->user()->role_id != 2)
                                        <a href="{{ route('pembelian.create') }}" class="mb-0 me-3"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Beli Produk Ini">
                                            <i class="bx bx-cart-plus-fill bi-sm"></i>
                                        </a>
                                        <a href="{{ route('stok-penyesuaian.index') }}" class="fw-bolder text-sm"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Sesuaikan Stok">
