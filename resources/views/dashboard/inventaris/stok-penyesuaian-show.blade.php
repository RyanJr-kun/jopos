                ...
                <table class="table table-hover align-items-center mb-0">
                    <thead class="table-secondary">
                        <tr>
                            ...
                            <th class="text-center text-uppercase text-dark text-xs font-weight-bolder">Stok Sebelum
                            </th>
                            <th class="text-center text-uppercase text-dark text-xs font-weight-bolder">Stok Setelah
                            </th>
                                    ...
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">
                                                {{ $detail->produk->nama_produk ?? 'Produk Dihapus' }}</h6>
