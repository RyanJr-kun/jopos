...
@section('layoutContent')
                ...
                <div class="row g-4 align-items-center">
                    @if ($promoImg->isNotEmpty())
                        <div class="col-lg-2 d-none d-lg-flex">
                            <div class="swiper myPromoSwiper w-100 rounded-3 overflow-hidden" style="min-height: 420px;">
                                <div class="swiper-wrapper">
                    ...
                    @endif
                    <div class="{{ $promoImg->isNotEmpty() ? 'col-lg-10' : 'col-12' }}">
                        @if ($produkPromotion->isNotEmpty())
                            <div
                                class="row row-cols-2 row-cols-md-3 {{ $promoImg->isNotEmpty() ? 'row-cols-lg-5' : 'row-cols-lg-6' }} g-3">
    ...
    {{-- section : Bestseller --}}
    @if ($bestsellerImg->isNotEmpty() || $produkTerlaris->isNotEmpty())
        <section id="best-seller" class="section-py">
            <div class="container-market">
                ...
                @if ($bestsellerImg->isNotEmpty())
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="swiper myBestsellerSwiper rounded-3 shadow-sm">
                                <div class="swiper-wrapper">
                ...
                @if ($produkTerlaris->isNotEmpty())
                    <div
                        class="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-3 {{ $bestsellerImg->isNotEmpty() ? 'mt-0' : 'mt-2' }}">
                                ...
                                <div class="card product-card overflow-hidden h-100 d-flex flex-column">
                                    <div class="product-card-img-container">
                                        ...
                                        <div class="product-card-actions">
                                            ...
                                            @else
                                                <button type="button" class="btn btn-light fw-bold w-100">Habis</button>
                                            @endif
                                        </div>
                                    </div>
