...
@section('breadcrumb')
    @php
        ...
        $breadcrumbItems = [
            ['name' => 'Dashboard', 'url' => '#'],
            ['name' => 'Manajemen Customer', 'url' => route('pelanggan.index')],
        ];
    @endphp
    ...
    <div class="card rounded-2">
        <div class="card-header pb-0 px-3 pt-2 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="mb-n1">List Customer</h6>
                ...
                <div class="ms-md-auto mt-2">
                    ...
                    <button class="btn btn-outline-info mb-0" data-bs-toggle="modal" data-bs-target="#createModal">
                        <i class="fa fa-plus cursor-pointer pe-2"></i>Customer
                    </button>
                </div>
            </div>
        </div>
        <div class="card-body px-0 pt-0 pb-2">
            ...
            <div id="pelanggan-table-container" class="mt-3">
                ...
                @include('content.penjualan._pelanggan_table', ['customers' => $customers])
            </div>
        </div>
    </div>
    {{-- modal-create --}}
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                fetchData(
                                    getCurrentPage()); // Muat ulang data di halaman saat ini
                            }
                        },
                        error: function(xhr) {
                            ...
                            Swal.fire('Gagal!', 'Periksa kembali data yang Anda masukkan.',
                                'error');
                        }
                    });
                });
