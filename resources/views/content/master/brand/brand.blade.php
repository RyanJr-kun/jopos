        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="createBrandForm" method="POST" action="{{ route('brand.store') }}" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                        ...
                        <div class="modal-footer border-0 pb-0 mt-3">
                            <button type="submit" id="submit-create-button" class="btn btn-outline-info btn-sm">Buat Brand</button>
                ...
                fetch(dataUrl)
                    ...
                    .then(data => {
                        ...
                        pondEditInput.addEventListener('FilePond:addfile', () => {
                            ...
                            submitEditBtn.innerHTML = `<span class="spinner-border spinner-border-sm"></span> Mengunggah...`;
                        });
