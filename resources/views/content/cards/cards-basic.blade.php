...
@section('content')
    ...
    <div class="row mb-12 g-6">
        <div class="col-md-6 col-lg-4">
            ...
            <div class="card mb-6">
                <div class="card-body">
                    <p class="card-text">This is some text within a card body. Jelly lemon drops tiramisu chocolate cake
                        cotton candy soufflé oat cake sweet roll. Sugar plum marzipan dragée topping cheesecake chocolate
                        bar. Danish muffin icing donut.</p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Cookie topping caramels jujubes gingerbread. Lollipop apple pie cupcake candy canes
                        cookie ice cream. Wafer chocolate bar carrot cake jelly-o.</p>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-4">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">With supporting text below as a natural lead-in to additional content natural
        ...
        <div class="col-md">
            <div class="card">
                <div class="d-flex flex-md-row flex-column">
                    <div>
                        <img class="card-img card-img-left" src="{{ asset('assets/img/elements/18.png') }}"
                            alt="Card image" />
                    </div>
                    <div>
                        <div class="card-body">
        ...
        <div class="col-md">
            <div class="card">
                <div class="d-flex flex-md-row flex-column">
                    ...
                    <div>
                        <img class="card-img card-img-right" src="{{ asset('assets/img/elements/19.png') }}"
                            alt="Card image" />
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card bg-primary text-white text-center p-4">
                <figure class="mb-0">
                    ...
                    <figcaption class="blockquote-footer mb-0 text-white">Someone famous in <cite
                            title="Source Title">Source Title</cite></figcaption>
                </figure>
            </div>
        </div>
