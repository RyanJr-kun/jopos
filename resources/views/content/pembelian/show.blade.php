                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        ...
                        <div class="border rounded-2 p-3">
                            ...
                            <p class="text-sm mb-2 d-flex justify-content-between"><strong>Status Barang:</strong> <span
                                    class="badge badge-sm {{ $pembelian->status_barang == 'Diterima' ? 'bg-label-success' : 'bg-label-warning' }}">{{ $pembelian->status_barang }}</span>
                            </p>
                            <p class="text-sm mb-2 d-flex justify-content-between"><strong>Status Bayar:</strong> <span
                                    class="badge badge-sm {{ $pembelian->status_pembayaran == 'Lunas' ? 'bg-label-success' : ($pembelian->status_pembayaran == 'Lunas Sebagian' ? 'bg-label-warning' : 'bg-label-danger') }}">{{ $pembelian->status_pembayaran }}</span>
                            </p>
                        ...
                        <tbody>
                            @foreach ($pembelian->details as $detail)
                                <tr>
                                    ...
                                    <td class="text-sm">{{ $detail->produk->name_product }}</td>
