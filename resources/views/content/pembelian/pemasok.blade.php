...
@section('breadcrumb')
    @php
        ...
        $breadcrumbItems = [
            ['name' => 'Page', 'url' => '#'],
            ['name' => 'Manajemen Supplier', 'url' => route('pemasok.index')],
        ];
    @endphp
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="ms-md-auto mt-2">
                    ...
                    <button class="btn btn-outline-info mb-0" data-bs-toggle="modal" data-bs-target="#createModal">
                        <i class="fa fa-plus fixed-plugin-button-nav cursor-pointer pe-2"></i>Supplier
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editSupplierForm" method="post">
                        @method('put')
                        @csrf
                        <x-pemasok-form-fields prefix="edit_" :pemasok="new \App\Models\Supplier()" />
