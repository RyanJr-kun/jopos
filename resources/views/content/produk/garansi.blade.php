...
@section('breadcrumb')
    @php
        $breadcrumbItems = [
            ...
            ['name' => 'Manajemen Warrantie', 'url' => route('garansi.index')],
        ];
    @endphp
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="ms-auto mt-2">
                    ...
                    <button class="btn btn-outline-info mb-0" data-bs-toggle="modal" data-bs-target="#import"><i
                            class="fa fa-plus fixed-plugin-button-nav cursor-pointer pe-2"></i>Buat Warrantie</button>
                </div>
            </div>
        </div>
                    ...
                    editModal.addEventListener('show.bs.modal', function(event) {
                        ...
                        fetch(dataUrl)
                            ...
                            .then(data => {
                                ...
                                const totalDays = data.duration; // Ini adalah total hari (misal: 400)
