            ...
            <div class="card-body">
                <div class="row g-3 d-flex align-items-center justify-content-start w-100 m-0">
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <select id="typeFilter" name="type" class="form-select select2" data-placeholder="Semua type">
                            <option value="">Semua type</option>
                            @foreach ($types as $typeName)
                                <option value="{{ $typeName }}" {{ request('type') == $typeName ? 'selected' : '' }}>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-nowrap">
                                            <div class="d-flex justify-content-center align-items-center gap-3">
                                                ...
                                                <a href="#" class="text-danger delete-user-btn" data-bs-toggle="modal"
