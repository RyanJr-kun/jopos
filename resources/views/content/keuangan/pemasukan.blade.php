    ...
    <div class="card rounded-2">
        ...
        <div class="card-body px-0 pt-0 pb-2">
            ...
            <div id="income-table-container">
                ...
                @include('content.keuangan._income_table', ['incomes' => $incomes])
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).ready(function() {
                ...
                function fetchData(page = 1) {
                    ...
                    let url = '{{ route('income.index') }}';

                    $('#income-table-container').css('opacity', 0.5); // Efek loading
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#income-table-container').html(data).css('opacity', 1);
                        ...
                        error: function() {
                            $('#income-table-container').css('opacity', 1);
