    ...
    <div class="card rounded-2">
        <div class="card-header pb-0 px-3 pt-2 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="me-2 ">
                    <h6 class="mb-n1">Riwayat Penyesuaian Stock</h6>
                ...
                <table class="table table-hover align-items-center mb-0">
                    ...
                    <tbody>
                        @forelse ($penyesuaians as $penyesuaian)
                            <tr>
                                <td class="ps-4">
                                    <p class="text-sm font-weight-bold mb-0">{{ $penyesuaian->kode_penyesuaian }}</p>
                                </td>
                                <td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center mt-3 mx-n5">
                ...
                <small class="text-danger ">Tindakan ini akan mengembalikan stok produk <br> ke keadaan semula dan tidak
