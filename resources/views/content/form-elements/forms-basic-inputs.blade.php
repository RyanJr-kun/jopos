                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="form-control" type="text" id="exampleFormControlReadOnlyInput1"
                            value="Readonly input here..." aria-label="readonly input example" readonly />
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="modalEditUserCountry" name="modalEditUserCountry" class="select2 form-select"
                            ...
                            <option value="" data-select2-id="110">Select</option>
                            <option value="Australia" data-select2-id="111">Australia</option>
                            <option value="Bangladesh" data-select2-id="112">Bangladesh</option>
                            <option value="Belarus" data-select2-id="113">Belarus</option>
                            <option value="Brazil" data-select2-id="114">Brazil</option>
                            <option value="Canada" data-select2-id="115">Canada</option>
                            <option value="China" data-select2-id="116">China</option>
                            <option value="France" data-select2-id="117">France</option>
                            <option value="Germany" data-select2-id="118">Germany</option>
                            <option value="India" selected="" data-select2-id="81">India</option>
                            <option value="Indonesia" data-select2-id="119">Indonesia</option>
                            <option value="Israel" data-select2-id="120">Israel</option>
                            <option value="Italy" data-select2-id="121">Italy</option>
                            <option value="Japan" data-select2-id="122">Japan</option>
                            <option value="Korea" data-select2-id="123">Korea, Republic of</option>
                            <option value="Mexico" data-select2-id="124">Mexico</option>
                            <option value="Philippines" data-select2-id="125">Philippines</option>
                            <option value="Russia" data-select2-id="126">Russian Federation</option>
                            <option value="South Africa" data-select2-id="127">South Africa</option>
                            <option value="Thailand" data-select2-id="128">Thailand</option>
                            <option value="Turkey" data-select2-id="129">Turkey</option>
                            <option value="Ukraine" data-select2-id="130">Ukraine</option>
                            <option value="United Arab Emirates" data-select2-id="131">United Arab Emirates</option>
                            <option value="United Kingdom" data-select2-id="132">United Kingdom</option>
                            <option value="United States" data-select2-id="133">United States</option>
                        </select>
                    ...
                    <div class="mb-4">
                        <label for="exampleFormControlSelect3" class="form-label">An example of a multi-select option is
                            the 'size' attribute</label>
                        <select class="form-select" id="exampleFormControlSelect3" size="2"
                ...
                <div class="row row-bordered g-0">
                    ...
                    <div class="col-xxl-6 col-xl-12 col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-check-reverse">
                                <input name="reverse-radio-1" class="form-check-input" type="radio" value=""
                                    id="reverseRadio1" />
                                <label class="form-check-label" for="reverseRadio1"> Unchecked </label>
                            </div>
                            <div class="form-check form-check-reverse">
                                <input name="reverse-radio-1" class="form-check-input" type="radio" value=""
                                    id="reverseRadio2" checked />
            ...
            <div class="card mb-6">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-md-10">
                            <input type="color" class="form-control" id="html5-color-input" value="#666EE8"
