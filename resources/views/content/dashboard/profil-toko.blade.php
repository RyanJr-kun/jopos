                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="name_toko" class="form-label">Nama Toko <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('name_toko') is-invalid @enderror"
                                    id="name_toko" name="name_toko" value="{{ old('name_toko', $profil->name_toko) }}"
                                    required>
                                @error('name_toko')
