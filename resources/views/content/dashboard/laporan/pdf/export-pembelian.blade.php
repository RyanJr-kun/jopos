            ...
            <tbody>
                @forelse ($purchases as $pembelian)
                    <tr>
                        ...
                        <td>{{ $pembelian->pemasok->name ?? 'N/A' }}</td>
                        ...
                        <td class="text-right {{ $pembelian->sisa_pembayaran > 0 ? 'text-danger' : '' }}">
                            @money($pembelian->sisa_pembayaran)</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="text-center">Tidak ada data pembelian yang ditemukan untuk periode
                            ini.</td>
                    </tr>
                @endforelse
            </tbody>
