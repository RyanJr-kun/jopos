...
class StockAdjustmentController extends Controller
{
    ...
    {
        $query = StockAdjustment::with('user')->latest();
        ...
        return view('content.inventaris.stok-penyesuaian-history', [
    ...
    {
        return view('content.inventaris.stok-penyesuaian-create', [
        ...
        try {
            DB::transaction(function () use ($validatedData) {
                ...
                foreach ($validatedData['items'] as $itemData) {
                    $produk = Product::find($itemData['product_id']);
    ...
    private function generateAdjustmentCode()
    {
        ...
        $lastAdjustment = StockAdjustment::where('kode_penyesuaian', 'like', $prefix . '%')
    ...
    public function show($kode_penyesuaian)
    {
        ...
        return view('content.inventaris.stok-penyesuaian-show', [
