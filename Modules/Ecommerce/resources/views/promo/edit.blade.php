...
@section('title', 'Edit Promo: ' . $promo->name)
...
@section('content')
    ...
    <form action="{{ route('promo.update', $promo->id) }}" method="POST" id="promoForm">
        @csrf
        @method('PUT')
        ...
        <div class="row g-4">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="LEBARAN25" style="letter-spacing:.5px;">
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type"
                                    name="type" required>
                                    <option value="percentage" @selected(old('type', $promo->type) == 'percentage')>
                                        Persentase (%)
                                    </option>
                                    <option value="fixed" @selected(old('type', $promo->type) == 'fixed')>
                                        Nominal Tetap (Rp)
                                    </option>
                                </select>
                                @error('type')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="nilai_diskon" value="{{ old('nilai_diskon', $promo->nilai_diskon) }}" required
                                        min="0">
                                    @error('nilai_diskon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="1"
                                        ...
                                        name="min_pembelian" value="{{ old('min_pembelian', $promo->min_pembelian ?? 0) }}"
                                        min="0">
                                    @error('min_pembelian')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6" id="max-diskon-wrapper">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="1"
                                        ...
                                        name="max_diskon" value="{{ old('max_diskon', $promo->max_diskon) }}"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local"
                                    ...
                                    name="tanggal_mulai"
                                    value="{{ old('tanggal_mulai', $promo->tanggal_mulai->format('Y-m-d\TH:i')) }}"
                                    required>
                                @error('tanggal_mulai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local"
                                    ...
                                    value="{{ old('tanggal_berakhir', $promo->tanggal_berakhir->format('Y-m-d\TH:i')) }}"
                                    required>
            ...
            <div class="col-lg-4 d-flex flex-column gap-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between p-3 rounded-2 bg-label-primary ">
                            ...
                            <div class="form-check form-switch ms-2 mb-0">
                                <input class="form-check-input" type="checkbox" role="switch" id="status"
                                    name="status" value="1" @checked(old('status', $promo->status))
                ...
                <div class="card border-0 shadow-sm flex-grow-1">
                    <div class="card-header py-3 d-flex align-items-center gap-2">
                        <span
                            class="avatar avatar-sm d-flex align-items-center justify-content-center bg-label-blue rounded">
                        ...
                        <div class="d-flex align-items-center justify-content-between p-3 rounded-2 bg-label-blue">
                            ...
                            <div class="form-check form-switch ms-2 mb-0">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_all_products"
                                    name="is_all_products" value="1" @checked(old('is_all_products', $promo->is_all_products))
                                    style="width:2.5em; height:1.4em; cursor:pointer;">
                            </div>
                        </div>
                        ...
                        <div id="products-wrapper">
                            ...
                            <select class="select2 form-select" id="products" name="products[]" multiple>
                                ...
                                @if (!empty($selectedProductIds))
                                    @foreach (Modules\Inventory\Models\Product::whereIn('id', $selectedProductIds)->get() as $produk)
...
@section('page-script')
    ...
    <script type="module">
        ...
        function formatProduct(produk) {
            ...
            const baseUrl = ASSET_STORAGE.replace(/\/$/, '');
            const imagePath = (produk.img_produk || '').replace(/^\//, '');
