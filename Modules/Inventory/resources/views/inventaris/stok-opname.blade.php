    ...
    <div class="card rounded-2">
        <div class="card-header pb-0 px-3 pt-2 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="mb-n1">Stock Opname</h6>
                ...
                <div class="ms-md-auto mt-2">
                    ...
                    <a href="{{ route('stok-opname.history') }}" class="btn btn-outline-secondary mb-0">
                        <i class="bx bx-clock-history me-2"></i>Riwayat
                    </a>
                </div>
            </div>
        </div>
        <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="row g-3 align-items-center justify-content-start">
                        <div class="col-md-4">
                            <input type="text" name="search" id="searchInput" class="form-control"
                                placeholder="Cari name atau SKU produk..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-3">
            ...
            <form action="{{ route('stok-opname.store') }}" method="POST" id="stockOpnameForm">
                <div class="p-3">
                    <div class="form-group">
                        ...
                        <textarea name="catatan_opname" id="catatan_opname" class="form-control" rows="2"
                            placeholder="Contoh: Stock opname bulanan untuk gudang utama"></textarea>
                    </div>
                </div>
                    ...
                    <table class="table table-hover align-items-center mb-0">
                        <thead class="table-secondary">
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-dark text-xs font-weight-bolder">Stock Fisik
                                </th>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        <p class="text-dark text-sm fw-bold mb-0">Tidak ada produk untuk ditampilkan.
                                        </p>
                                    </td>
                                </tr>
                            @endforelse
                ...
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-info" {{ $products->isEmpty() ? 'disabled' : '' }}>
