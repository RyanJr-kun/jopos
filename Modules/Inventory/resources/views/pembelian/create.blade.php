            ...
            <div class="row g-2">
                <div class="col-md-3">
                    ...
                    <div class="d-flex">
                        ...
                        @enderror
                        <button type="button" class="btn btn-outline-info btn-xs rounded-3 mb-0 ms-2"
                            data-bs-toggle="modal" data-bs-target="#createSupplierModal" title="Tambah Supplier Baru">
                ...
                <div class="col-md-3 ms-auto">
                    ...
                    <input type="text" class="form-control @error('referensi') is-invalid @enderror" id="referensi"
                        name="referensi" value="{{ old('referensi', $nomer_referensi) }}" required>
                    @error('referensi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
